...
import VariantNegativeSizeMNume from "./TagCard";

const SectionEmpresas: FunctionComponent = () => {
  ...
  return (
    <section className="relative bg-whitesmoke w-full h-[835px]* overflow-y-auto flex flex-col items-start justify-start text-left text-[32px]  font-poppins h-[120vh] ">
      ...
      <div className="self-stretch flex flex-col items-start justify-start py-2.5 px-5 gap-[20px]">
        ...
        <div className=" rounded-xl bg-white h-[65px] w-full flex items-center justify-center box-border relative text-left text-sm text-slategray font-poppins">
      ...
      <div className="self-stretch flex flex-col items-center justify-start gap-[10px] text-right text-sm text-text-primary font-caption-s">
        ...
        <div className="self-stretch flex flex-row items-center justify-end py-0 px-5 gap-[5px]">
          ...
          <input
            className="[outline:none] font-caption-s text-sm bg-white rounded shadow-[0px_1px_2px_rgba(42,_54,_71,_0.08)_inset] box-border w-[237px] overflow-hidden shrink-0 flex flex-col items-start justify-center py-1.5 px-5 text-darkgray border-[1px] border-solid border-divider-strong1"
            placeholder="Buscar"
            type="text"
            value={inputValue}
              ...
              <div className="relative rounded-2xl bg-white shadow-[0px_4px_4px_rgba(0,_0,_0,_0.25),_0px_0px_2px_rgba(145,_158,_171,_0.2),_0px_12px_24px_-4px_rgba(145,_158,_171,_0.12)] w-60 h-[100px] mt-[-67px]">
                <div className="absolute top-[14px] left-[20px] w-[200px] overflow-hidden flex flex-col items-start justify-center">
                  <div className="w-[197px] flex flex-col items-start justify-start gap-[5px]">
                    ...
                    <b className="relative text-3xs">Creada por: Christian lanza</b>
                    <div className="self-stretch h-[31px] flex flex-row items-center justify-between text-5xs">
                      ...
                      <div className="flex flex-row items-center justify-end gap-[5px]">
                        <button className="cursor-pointer [border:none] py-0 px-2.5 bg-rosa rounded-lg overflow-hidden flex flex-row items-center justify-center">
